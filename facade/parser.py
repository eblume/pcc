...
class Parser:
    def __init__(self, lexer):
        """LALR parser of arbitrary BNF-like rules.
    ...
    def parse(self,input):
        ...
        Note that some LALR parser generators produce parsers that will return
        ...
        It is also important to note that parsing will proceed using an LALR
        table-based parser, which is not the most efficient form of parsing
        (although it is very well suited to a wide array of problems). As a
        result, parsing may be very slow for large inputs.
        """
        pass
